    ...
    >
      <div className="max-w-7xl mx-auto px-4 h-20 flex justify-between items-center">
        ...
        <button
          ...
          className="md:hidden text-2xl font-bold focus:outline-none flex-shrink-0 transition-transform duration-300 hover:scale-110"
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed top-20 left-0 right-0 bg-white border-b border-gray-200 w-full z-40 shadow-md animate-slide-down">
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex flex-col gap-1 font-medium text-center">
              <a 
                href="#menu" 
                className="text-gray-800 hover:text-yellow-600 hover:bg-yellow-50 transition-all duration-200 py-3 rounded-lg px-4"
              ...
              {isAuthenticated ? (
                <button
                  onClick={handleLogout}
                  className="text-red-500 hover:text-red-700 hover:bg-red-50 transition-all duration-200 py-3 rounded-lg px-4"
                >
                  Cerrar sesión
                </button>
              ) : (
